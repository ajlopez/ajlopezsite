...
?>
<p>
<a href="CategoriaNoticiaGraba.php?<?php echo $Parametros; ?>">Selecciona esta Categor&iacute;a</a>
</p>
<p>
<a href="CategoriaSeleccionaNot.php?<?php echo $Subparametros ?>">Categor&iacute;as</a>
<?php
	if ($IdPadre) {
		echo "&nbsp;->&nbsp;";
