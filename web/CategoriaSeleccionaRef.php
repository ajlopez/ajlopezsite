<?
	...
	$Subparametros = "IdReferente=$IdReferente";
...
?>
<p>
<a href="CategoriaRefGraba.php?<? echo $Parametros; ?>">Selecciona esta Categor&iacute;a</a>
</p>
<p>
<a href="CategoriaSeleccionaRef.php?<? echo $Subparametros ?>">Categor&iacute;as</a>
<?
	if ($IdPadre) {
		echo "&nbsp;->&nbsp;";
		echo CategoriasEnlaces($IdPadre,"CategoriaSeleccionaRef.php?$Subparametros","IdCategoria");
	}
?>
</p>
<?
...
?>
<p>
<a href="CategoriaRefGraba.php?<? echo $Parametros; ?>">Sin Referencia</a>
</p>
<?
	}
?>
...
function MuestraCategoria($Id,$Descripcion,$Resumen,$x,$y)
{
	...
	echo "<td width='33%' height=30 class=categoria valign=top bgcolor=$fondo><a class=categoria href='CategoriaSeleccionaRef.php?IdCategoria=$Id&$Subparametros'>$Descripcion</a><br>$Resumen</td>\n";
}
