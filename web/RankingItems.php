...
<p>
<a href="RankingItems?Desde=0<?php echo $Parametros; ?>">Inicio</a>
&nbsp;&nbsp;
<a href="RankingItems?Desde=<?php echo $Anterior; ?><?php echo $Parametros; ?>">Anterior</a>
&nbsp;&nbsp;
<a href="RankingItems?Desde=<?php echo $Siguiente; ?><?php echo $Parametros; ?>">Siguiente</a>
&nbsp;&nbsp;
<a href="RankingItems?Desde=<?php echo $Ultimo; ?><?php echo $Parametros; ?>">Final</a>
&nbsp;&nbsp;
<p>
